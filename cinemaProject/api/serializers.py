...
class MovieHallReadSerializer(serializers.ModelSerializer):
    class Meta:
        model = MovieHall
...
class UserOrdersSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ["id", "username", "email", "first_name", "last_name", "orders", "total_spent"]
